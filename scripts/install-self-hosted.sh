...
EXPECTED_SHA256=356b118da80056770b30a80314f64e118040054086cefe5ee73f4148141a85ec
...
if [ -e "$target" ]; then
  ...
  case "$installed" in
    0.1.0|0.1.1|0.1.2|0.2.0|0.3.0|0.3.1|0.4.0|0.4.1|0.4.2|0.4.3|0.4.4|0.4.5|0.4.6) ;;
    *)
